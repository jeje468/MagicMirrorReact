...
// // Type for response from Daily.co API
...
//   //const { caller, callee } = req.body as CreateRoomRequest;
...
//     const data: DailyRoomResponse = await response.json() as DailyRoomResponse;
...
import express, { Request, Response } from "express";
import dotenv from "dotenv";
import fetch from "node-fetch"; // Use 'node-fetch' for consistency in older Node or add 'type: module' to package.json for native fetch.
